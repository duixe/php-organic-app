            ...
            <li class="nav-item dropdown no-arrow d-sm-none">
             ...
             <li class="nav-item dropdown no-arrow">
               <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                 <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php if(isAuthenticated()): ?> <?php echo e(user()->fullname); ?> <?php endif; ?></span>
               ...
               <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                 <a class="dropdown-item" href="#">
                   ...
                   <?php if(isAuthenticated()): ?> <?php echo e(user()->role); ?> <?php endif; ?>
                 </a>
...
<?php /**PATH /var/www/html/organicstore/resources/views/admin/layout/base.blade.php ENDPATH**/ ?>